...
INSERT INTO city (name, state_id, zipcode_start, zipcode_end) VALUES ('수원시', @gyoenggi, 16200, 16799), ('성남시', @gyoenggi, 13100, 13799), ('의정부시', @gyoenggi, 11600, 11899), ('안양시', @gyoenggi, 13900, 14199), ('부천시', @gyoenggi, 14400, 14899), ('광명시', @gyoenggi, 14200, 14399), ('동두천시', @gyoenggi, 11300, 11399), ('평택시', @gyoenggi, 17700, 18099), ('안산시', @gyoenggi, 15200, 15799), ('고양시', @gyoenggi, 10200, 10799), ('과천시', @gyoenggi, 13800, 13899), ('구리시', @gyoenggi, 11900, 11999), ('남양주시', @gyoenggi, 12000, 12399), ('오산시', @gyoenggi, 18100, 18199), ('시흥시', @gyoenggi, 14900, 15199), ('군포시', @gyoenggi, 15800, 15999), ('의왕시', @gyoenggi, 16000, 16199), ('하남시', @gyoenggi, 12900, 13099), ('용인시', @gyoenggi, 16800, 17299), ('파주시', @gyoenggi, 10800, 10999), ('이천시', @gyoenggi, 17300, 17499), ('안성시', @gyoenggi, 17500, 17699), ('김포시', @gyoenggi, 10000, 10199), ('화성시', @gyoenggi, 18200, 18799), ('광주시', @gyoenggi, 12700, 12899), ('양주시', @gyoenggi, 11400, 11599), ('포천시', @gyoenggi, 11100, 11299), ('여주시', @gyoenggi, 12600, 12699), ('연천군', @gyoenggi, 11000, 11099), ('가평군', @gyoenggi, 12400, 12499), ('양평군', @gyoenggi, 12500, 12599);
